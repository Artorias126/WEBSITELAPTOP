...
export const orderSlide = createSlice({
  ...
  reducers: {
    ...
    decreaseAmount: (state, action) => {
      ...
      // Kiểm tra nếu số lượng > 0 mới giảm
      if (itemOrder && itemOrder.amount > 0) itemOrder.amount--;
      if (itemOrderSelected && itemOrderSelected.amount > 0) itemOrderSelected.amount--;
    },
